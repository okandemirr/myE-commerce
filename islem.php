...
if (isset($_POST['register'])) {
	...
	$kullanicisor=$baglanti->prepare("SELECT * from kullanici where kullanici_adi=:kullanici_adi and kullanici_yetki=:kullanici_yetki  or kullanici_mail=:kullanici_mail");
	$kullanicisor->execute(array(
		'kullanici_adi'=>$kadi,
		'kullanici_yetki'=>1,
		'kullanici_mail'=>$mail
