  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Siparişinizi Güncellemek Mi İstiyorsunuz ?</h5>
...
Ama Eğer 24 Saat Geçti İse O Zaman Kargoya Çıkacağı İçin Siparişi Güncelleyemezsiniz.


      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">KAPAT</button>
      <a href="siparisguncelle"><button type="button" class="btn btn-success">Siparişi Güncelle</button></a>  
      </div>
    </div>
  </div>
</div>
