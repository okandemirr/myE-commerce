...
<head>
    ...
    <body>
        ...
        <div class="body-wrapper">
            <!-- Begin Header Area -->
            <header>
                 <div style="background-color:#4b4b4b" class="header-top">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="header-top-left">
                                    <ul class="phone-wrap">
                                        <li><span style="color:white; font-size: 15px;">Telefon : </span><a style="color:white;font-size: 15px;" href="#"><?php echo $ayarcek['telefon'] ?></a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9 col-md-8">
                                <div class="header-top-right">
                                    <ul class="ht-menu">
                                        <!-- Begin Setting Area -->
                                        <li>
                                            <div class="ht-setting-trigger"><span style="color:white; font-size: 15px;">Hesabım</span></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="logo pb-sm-30 pb-xs-30">
                                    <a href="index.html">
                                        <img width="250px" height="70px" src="logo4.png" alt="">
                                    </a>
                                </div>
                            </div>
...
$sepettoplam+=$value * $urunlercek['urun_fiyat'] ;
                ...
                <div class="header-bottom header-sticky d-none d-lg-block d-xl-block">
                                         ...
                                         <li><a href="index">Anasayfa</a></li>
                                            <li class="megamenu-holder"><a href="">Kategorİler</a>
                                                <ul class="megamenu hb-megamenu">
                                                    <li><a href="shop-left-sidebar.html">Erkek</a>
                                                        <ul>
                                                             <?php  
                  $kategori=$baglanti->prepare("SELECT * FROM  kategori  where kategori_durum=:kategori_durum and  kategori_sira  between 1 and 2 limit 8 ");
                  ...
                  while ($kategoricek=$kategori->fetch(PDO::FETCH_ASSOC)) { ?>
                                                    ...
                                                    <li><a href="shop-left-sidebar.html">Kadın</a>
                                                        <ul>
                                                               <?php  
                  $kategori=$baglanti->prepare("SELECT * FROM  kategori   where  kategori_durum=:kategori_durum and kategori_sira  between 3 and 4 limit 8 ");
                  $kategori->execute(
array(
                  ...
                  while ($kategoricek=$kategori->fetch(PDO::FETCH_ASSOC)) { ?>
                                                    ...
                                                    <li><a href="shop-left-sidebar.html">Çoçuk</a>
                                                        <ul>
                                                               <?php  
                  $kategori=$baglanti->prepare("SELECT * FROM  kategori  where  kategori_durum=:kategori_durum and  kategori_sira  between 5 and 6 limit 8 ");
                  $kategori->execute(array(
